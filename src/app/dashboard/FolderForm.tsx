...
export default function FolderForm({ handleCreateFolder }: { handleCreateFolder: (formData: FormData) => void }) {
  ...
  return (
    <form className='mb-4 w-full flex gap-x-2 items-center' action={(formData) => {
      ...
      <div className='grow'>
        ...
        <input className='shadow appearance-none border-2 border-gray-700 rounded w-full py-2 px-3 leading-tight focus:outline-none focus:shadow-outline bg-transparent' name='name' id='name' type='text' placeholder='my folder' />
      </div>
